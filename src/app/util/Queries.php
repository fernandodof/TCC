...
class Queries {
    ...
    const CHECK_LOGIN_EXISTS = 'SELECT count (c.login) FROM Cliente c WHERE c.login = :login';
    const CHECK_EMAIL_EXISTS = 'SELECT count (c.email) FROM Cliente c WHERE c.email = :email';
    //Native Queries
    ...
    const CHECK_LOGIN_EXISTS_N = 'SELECT count(c.login) as count FROM Cliente c WHERE c.login LIKE :login';
    const CHECK_EMAIL_EXISTS_N = 'SELECT count(c.email) as count FROM Cliente c WHERE c.email LIKE :email';
