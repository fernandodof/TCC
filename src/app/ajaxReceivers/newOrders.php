                ...
                echo "<div class='pedidoDiv'id='pedidoRecebidoDiv" . $i . "'>";
                    ...
                    echo "<label class='pull-right valorTotal'>TOTAL: R$ " . $pedido->getValorTotal() . "</label>";
                        echo "<div class='infoCliente'>";
                            ...
                            echo "<h4 data-toggle='collapse' data-target='#enderecoNovosPedidos" . $i . "' class='elementToggle verEndereco'>Clique Aqui Para Ver o Endereço <i class='fa fa-chevron-circle-down'></i></h4>";
