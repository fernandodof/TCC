<div class="container">
    <form role="form" class="form-horizontal col-md-6 col-lg-offset-3 {*subscribeForm*}" action="../src/app/processes/ProcessCliente.php" method="post">
        <h2>Cadastro</h2>
        ...
        <div class="form-group">
            <input type="text" name="telefone" class="form-control" placeholder="Número do Telefone" required/>
        </div>
        <h3>Endereço</h3>
        <div class="form-group">
